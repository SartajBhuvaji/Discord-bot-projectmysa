...
module.exports = (bot,msg)=>{
  ...
  if (message.content.substring().split(" ")[0] === "!sa" && message.content.substring().split(" ")[1]=== "soundplay") {
    execute(message, serverQueue);
    return;
  }else if (message.content.substring().split(" ")[0] === "!sa" &&message.content.substring().split(" ")[1]=== "soundskip") {
    skip(message, serverQueue);
    return;
  }else if (message.content.substring().split(" ")[0] === "!sa" &&message.content.substring().split(" ")[1]=== "soundstop") {
