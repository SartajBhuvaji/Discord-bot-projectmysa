...
module.exports = (bot,message)=>{
  ...
  */
  ...
  if (message.content.substring().split(" ")[0] === "!sa" && message.content.substring().split(" ")[1]=== "play") {
    execute(message, serverQueue);
    return;
  } else if (message.content.substring().split(" ")[0] === "!sa" &&message.content.substring().split(" ")[1]=== "skip") {
    skip(message, serverQueue);
    return;
  } else if (message.content.substring().split(" ")[0] === "!sa" &&message.content.substring().split(" ")[1]=== "stop") {
